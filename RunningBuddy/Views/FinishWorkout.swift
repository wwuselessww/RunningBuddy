...
#Preview {
    ...
    NavigationStack {
        FinishWorkout(isRecordedByWatch: false, workout: .init(pace: 10, distance: 10, duration: 0, path: [], calories: 10, avgHeartRate: 10, maxHeartRate: 10, type: .outdoorRun), path: $path)
    }
}
