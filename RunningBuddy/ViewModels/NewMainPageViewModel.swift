...
@Observable class NewMainPageViewModel {
    ...
    var chosenDateStart: Date = Calendar.current.startOfDay(for: Date.now)
    var chosenDateEnd: Date = Calendar.current.startOfDay(for: Date.now)
    ...
    public func fetchPhoneWorkouts(){
        hkWorkouts = []
        do {
